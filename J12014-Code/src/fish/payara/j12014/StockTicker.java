...
public class StockTicker {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        MutableCacheEntryListenerConfiguration<String,Stock> listenerConfig = 
                new MutableCacheEntryListenerConfiguration<>(FactoryBuilder.factoryOf(new StockListener()),null,false,false);
